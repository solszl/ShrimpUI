 ...
 **/
package com.thirdparts.greensock
{
...
//---- STATIC FUNCTIONS -------------------------------------------------------------------------
		...
		public static function tweenNumber(start:Number,end:Number,duration:Number,onUpdate:Function,onComplete:Function =null,ease:Function=null):Object
		{
			var obj:Object = {pro:start};
			TweenNano.to(obj,duration,{pro:end,onUpdate:function():void{onUpdate(obj.pro)},onComplete:onComplete,ease:ease});
			return obj;
		}
